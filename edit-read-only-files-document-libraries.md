...
- Si vous préférez avoir des documents ouverts en modification dans Office Online lorsque vous cliquez sur le titre, vous pouvez configurer la bibliothèque pour qu’elle effectue cette opération (tant que vous avez l’autorisation de modifier les paramètres de la bibliothèque).
