...
1. Dans le volant qui s’affiche, développez **Paramètres du courrier,** puis cliquez sur **Modifier** pour **le forwarding de courrier électronique.**
1. Supprimez les adresses de forwarding que vous ne connaissez pas.