...
Si vous souhaitez en savoir plus, consultez l’article [Mettre à jour ou réparer les paramètres d’un domaine fédéré dans Office 365, Azure ou Intune](https://docs.microsoft.com/fr-FR/office365/troubleshoot/active-directory/update-federated-domain-office-365).
