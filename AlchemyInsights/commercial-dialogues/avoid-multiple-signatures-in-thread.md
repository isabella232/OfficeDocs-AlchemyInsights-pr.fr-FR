...
---
# <a name="avoid-multiple-signatures-from-being-added-in-an-email-conversation"></a>Éviter l’ajout de plusieurs signatures dans une conversation par courrier électronique

Pour obtenir une clause d’exclusion de responsabilité ou une signature ajoutée une seule fois par thread de messagerie, vous devez modifier le paramètre dans le Centre d’administration Exchange.
