...
Ne choisissez pas une étiquette parente comme étiquette par défaut, ne configurez pas non plus une étiquette parent pour l’appliquer automatiquement ou la recommander, car elle ne sera pas appliquée au contenu des applications Office qui utilisent le client d’étiquetage unifié Azure Information Protection. Pour plus d’informations, consultez la section [Sous-étiquettes (regroupement d’étiquettes)](https://docs.microsoft.com/microsoft-365/compliance/sensitivity-labels).