...
La fonctionnalité de surveillance a été remplacée par la conformité des communications. Si vous avez actuellement des stratégies de surveillance configurées dans le Centre de sécurité & conformité, vous devez les faire passer aux stratégies de conformité des communications Microsoft 365. Il n’existe aucun outil de migration pour migrer ces stratégies . Au lieu de cela, vous devez créer de nouvelles stratégies de conformité des communications pour remplacer vos stratégies de surveillance existantes.
