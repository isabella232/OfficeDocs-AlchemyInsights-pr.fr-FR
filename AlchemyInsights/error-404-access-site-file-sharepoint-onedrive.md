...
---
# <a name="error-404-file-not-found-in-sharepoint-or-onedrive"></a>Erreur 404 : fichier introuvable dans SharePoint ou OneDrive
...
- [Rechercher dans le journal d’audit dans &amp; le centre de sécurité conformité](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance): recherchez dans le journal d’audit (si la journalisation est activée) si vous ne parvenez toujours pas à trouver l’élément.