...
6. Une fois connecté, vous pouvez accéder à la page **facturation** de \> [vos produits](https://go.microsoft.com/fwlink/p/?linkid=842054) pour vérifier que vos abonnements achetés sont activés au sein de votre client. (Vous pouvez également choisir l’onglet **abonnement** dans le VLSC pour afficher les détails vérifiant que votre abonnement a été déposé.)
