...
Les options de paiement pour les abonnements Office 365 pour les entreprises sont les suivants : carte bancaire, compte bancaire (prélèvement) et facture (paiement par chèque ou par transfert électronique de fonds).
  
**Payer par carte bancaire et compte bancaire**
...
Si votre carte bancaire est refusée ou si votre compte présente un arriéré de paiement, vous pouvez choisir l’option **Régler le solde** dans la page **Facturation** \> [Produits et services](https://portal.office.com/adminportal/home#/subscriptions).
