...
- Si vous avez déjà téléchargé les applications Office, vous devrez peut-être vous y connectez avec votre compte scolaire ou scolaire. Vous pouvez le faire dans n’importe quelle application Office (Word, Excel, etc.) en cliquant sur Compte de Office  >   fichier (vers le bas). Sous **Informations utilisateur,** sélectionnez **Changer de compte.** Pour plus d’informations, [voir Installer Office applications.](/microsoft-365/admin/setup/install-applications)
