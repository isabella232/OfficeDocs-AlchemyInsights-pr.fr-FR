...
ms.locfileid: "32420338"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Résolution des problèmes liés au certificat Apple MDM dans Microsoft Intune

Passez en revue les ressources indiquées ci-dessous pour résoudre votre problème dès maintenant. 
  
1. Consultez [ce document](https://docs.microsoft.com/intune/apple-mdm-push-certificate-get) pour configurer ou renouveler un certificat d'Apple GPM. 
