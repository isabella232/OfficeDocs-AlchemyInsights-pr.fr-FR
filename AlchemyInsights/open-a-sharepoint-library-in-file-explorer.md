...
ms.locfileid: "32419559"
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>Ouvrir une bibliothèque SharePoint dans l'Explorateur de fichiers

1. Naviguez jusqu'à la bibliothèque dans Internet Explorer 10 ou Internet Explorer 11. 
    
2. Cliquez sur l'icône Afficher en haut à droite, puis cliquez sur **afficher dans l'Explorateur de fichiers**.
