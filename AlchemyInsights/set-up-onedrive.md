...
---
# <a name="use-the-onedrive-syn-client-to-sync-onedrive-or-sharepoint-files"></a>Utiliser le client syn OneDrive pour synchroniser des fichiers OneDrive ou SharePoint
