...
Suivez les instructions pas à pas ici : gérer les [personnes autorisées à créer des groupes Office 365](https://docs.microsoft.com/office365/admin/create-groups/manage-creation-of-groups)
