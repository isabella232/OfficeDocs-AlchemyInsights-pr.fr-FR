...
Vous pouvez également conserver ce contenu en ajoutant la boîte aux lettres à une stratégie de rétention. Cela place le contenu dans les boîtes aux lettres principale et d’archivage en conservation. Pour plus d’informations sur la création de stratégies de rétention pour conserver les messages électroniques, suivez les étapes décrites [ici](https://docs.microsoft.com/Office365/securitycompliance/retention-policies).
