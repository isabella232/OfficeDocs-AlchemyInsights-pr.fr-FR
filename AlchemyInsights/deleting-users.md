...
ms.locfileid: "51815433"
---
# <a name="deleting-users"></a>Suppression d’utilisateurs

Si vous souhaitez bloquer immédiatement l'accès des utilisateurs et conserver leurs informations, consultez Bloquer l'accès d'un ancien employé aux [données Microsoft 365.](https://docs.microsoft.com/microsoft-365/admin/add-users/remove-former-employee#block-a-former-employees-access-to-microsoft-365-data)
