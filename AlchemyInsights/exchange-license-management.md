...
- Pour **attribuer** des licences Exchange, accédez à **Facturation > [Licences](https://go.microsoft.com/fwlink/p/?linkid=842264)**, sélectionnez l’abonnement et les utilisateurs, puis cliquez sur **Attribuer des licences**. Pour plus d’informations, consultez [Attribuer des licences](https://docs.microsoft.com/microsoft-365/admin/manage/assign-licenses-to-users?view=o365-worldwide).
...
- Pour **annuler** des licences Exchange, accédez à **Facturation > [Produits et services](https://go.microsoft.com/fwlink/p/?linkid=842054),** sélectionnez **Paramètres et actions**, puis cliquez sur **Annuler l’abonnement**. Pour plus d’informations, consultez [Annuler votre abonnement](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/cancel-your-subscription).
