...
Si vous trouvez que vos abonnements achetés via un **Accord Entreprise** de licence en volume ont été activés sur le mauvais client **ou** si vous souhaitez transférer des **licences** d’un client à un autre, contactez le [support](/microsoft-365/admin/contact-support-for-business-products)technique.