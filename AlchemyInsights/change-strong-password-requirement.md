...
- [Configurer les mots de passe utilisateur pour qu'ils n'expirent jamais](https://docs.microsoft.com/microsoft-365/admin/add-users/set-password-to-never-expire)
