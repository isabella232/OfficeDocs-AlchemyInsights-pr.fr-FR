...
Souhaitez-vous autoriser vos utilisateurs à contacter des utilisateurs de Skype client ? Pour [les utilisateurs de Skype entreprise, consultez la rubrique Let Add Skype contacts](https://docs.microsoft.com/skypeforbusiness/set-up-skype-for-business-online/let-skype-for-business-users-add-skype-contacts). 