...
- **Restauration des groupes supprimés.** La restauration de groupes Yammer est possible via [la restauration d’un groupe Office 365 supprimé](https://docs.microsoft.com/office365/admin/create-groups/restore-deleted-group) les groupes non connectés ne peuvent pas être restaurés après la suppression.
