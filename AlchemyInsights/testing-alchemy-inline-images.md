...
ms.locfileid: "36507161"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="eb6b0-102">Accéder à la page domaines</span><span class="sxs-lookup"><span data-stu-id="eb6b0-102">Access the Domains Page</span></span>

<span data-ttu-id="eb6b0-103">Pour accéder à la page domaines, cliquez simplement sur cette icône ci-dessous:</span><span class="sxs-lookup"><span data-stu-id="eb6b0-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="eb6b0-104">Ensuite, vous pouvez ajouter, modifier ou supprimer votre domaine.</span><span class="sxs-lookup"><span data-stu-id="eb6b0-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="eb6b0-105">Pour plus d’informations, consultez le [Forum aux questions sur les domaines.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="eb6b0-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
