...
Lorsque vous essayez de désinstaller Office 365 proPlus à partir d'un ordinateur et que vous obtenez le message d'erreur, un problème est **survenu 30016-4**, cela signifie que le lecteur **% temp%** est mappé sur un lecteur différent de **% ProgramFiles%**.
