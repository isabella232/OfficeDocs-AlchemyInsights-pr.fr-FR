...
Lorsque vous essayez d’installer Office 365, un message d’erreur de **système d’exploitation non pris en charge** peut s’afficher si votre appareil ne répond pas à la [Configuration système requise](https://products.office.com/office-system-requirements).
  
Office 365 nécessite les éléments suivants:
