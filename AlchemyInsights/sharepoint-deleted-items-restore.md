...
ms.locfileid: "53942059"
---
# <a name="restore-deleted-items-from-sharepoint"></a>Restaurer des éléments supprimés de SharePoint
...
- [Supprimer des éléments ou vider la Corbeille](https://support.office.com/article/delete-items-or-empty-the-recycle-bin-of-a-sharepoint-site-2e713599-d13e-40d6-96dc-66f0a366f74e#ID0EAADAAA=Online)

- [Restituer une collection de sites supprimée (y compris le groupe, la communication et d’autres sites).](https://docs.microsoft.com/sharepoint/restore-deleted-site-collection )

- [Restaurer une OneDrive](https://docs.microsoft.com/onedrive/restore-deleted-onedrive)

- [SharePoint PNP en ligne](https://docs.microsoft.com/powershell/sharepoint/sharepoint-pnp/sharepoint-pnp-cmdlets?view=sharepoint-ps)
