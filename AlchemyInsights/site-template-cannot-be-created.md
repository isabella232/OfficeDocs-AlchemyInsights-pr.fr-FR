---
title: Modèle de site ne peut pas être créé
ms.author: pebaum
author: pebaum
manager: scotv
ms.audience: Admin
...
---
# <a name="site-template-cannot-be-created"></a>Modèle de site ne peut pas être créé

Il se peut que le modèle n’ait pas de fonctionnalité et ne soit pas activé. Si la fonctionnalité n’est pas disponible pour activation dans la collection de sites actuelle, vous ne pouvez pas utiliser le modèle de site pour créer un site.
...
Pour plus d’informations sur les problèmes courants et les solutions, consultez [Créer et utiliser des modèles de site](https://support.office.com/article/Create-and-use-site-templates-60371B0F-00E0-4C49-A844-34759EBDD989).
