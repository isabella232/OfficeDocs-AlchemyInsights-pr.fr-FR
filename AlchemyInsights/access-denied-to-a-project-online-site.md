...
---
# <a name="help-with-permissions-in-project-online"></a>Aide sur les autorisations dans Project Online
...
2. Sur la page d'accueil de Project Web App, sélectionnez **partager**, disponible dans le coin supérieur droit.
