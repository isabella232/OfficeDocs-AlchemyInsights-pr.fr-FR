...
ms.locfileid: "28287641"
---
# <a name="how-to-enable-seamless-sso"></a>Comment faire pour activer l’authentification unique transparente

Activer l’authentification unique transparente par le biais de [connexion Azure AD](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect).
...
Pour plus d’informations, voir [Azure Active Directory transparente Single Sign-On : Guide de démarrage rapide](https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-sso-quick-start).
